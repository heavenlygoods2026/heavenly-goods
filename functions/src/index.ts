 ...
 */
export const syncProductToStripe = functions.runWith({ secrets: ["STRIPE_SECRET_KEY"] }).firestore
 ...
 */
export const stripeWebhook = functions.runWith({ secrets: ["STRIPE_WEBHOOK_SECRET", "STRIPE_SECRET_KEY"] }).https.onRequest(async (req, res) => {
